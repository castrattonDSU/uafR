...
The listed time ranges are planning estimates. The locally approved schedule
controls actual participation. Weekend activities count toward the total
program workload and should not be added on top of a participant's agreed
hours.
...
\begin{itemize}
  \item Current public uafR installation route or a verified offline student bundle.
  ...
  \item A local supplement documenting the approved schedule, compensation or credit terms, accommodations, safety procedures, data access, and support contacts.
\end{itemize}
\end{checklistbox}

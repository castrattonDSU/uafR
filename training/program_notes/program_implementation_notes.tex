...
\begin{itemize}
  \item Prepare the current public uafR installation route or a verified offline student bundle.
...
\section{Local Program Supplement}
Before enrollment or employment begins, provide a short locally approved
supplement that states the actual calendar, expected weekly hours, how weekend
tasks count toward those hours, compensation or credit terms, holidays,
supervision, accommodations, laboratory safety requirements, emergency
contacts, and data-access rules. The 70-day curriculum defines learning
activities; it does not supersede institutional employment, academic,
accessibility, or safety requirements.

Keep unpublished project names, restricted-data locations, credentials, and
internal scheduling details in the local supplement or another approved
controlled location. Do not add them to the public manual or student bundle.

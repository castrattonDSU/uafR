  ...
  specs = list(
    ...
    .categorate_schema("KEGGMatches",
                       ...
                       required = c("Query", "KEGG_ID", "Database",
                                    "MatchStatus"),
                       role = "metabolism",
                       description = "Accepted exact-normalized KEGG name/ID resolution matches."),
    .categorate_schema("KEGGSearchCandidates",
                       c("Query", "KEGG_ID", "Database", "MatchName",
                         "MatchStatus", "MatchScore", "MatchRank",
                         "SourceURL", "RetrievedAt", "Accepted",
                         "RejectionReason"),
                       required = c("Query", "KEGG_ID", "Database",
                                    "Accepted"),
                       role = "metabolism",
                       description = paste(
                         "All KEGG name-search candidates, including broad",
                         "matches rejected from biochemical enrichment."
                       )),

...
| --- | --- | --- | --- |
| PubChem | <https://pubchem.ncbi.nlm.nih.gov/docs/pug-rest> | Compound identity, properties, structure, annotations, source links, literature context, and taxonomy-linked occurrence candidates after exact taxon-ID verification through NCBI Datasets v2 | A PubChem record or annotation is not confirmation in a project sample. |
...
| NCBI Datasets Taxonomy | <https://www.ncbi.nlm.nih.gov/datasets/docs/v2/api/rest-api/> | Candidate NCBI Taxonomy IDs for PubChem taxonomy queries, accepted only after exact normalized scientific-name and rank verification | A suggested or related taxon is never accepted as an exact species match. |
